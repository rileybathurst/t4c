...
const CalendarIDRPage = ({ data }) => {
  return (
    ...
    <>
        ...
        <h1><Link to="/calendar">Calendar</Link> / IDR</h1>
...
export default CalendarIDRPage

export const pageQuery = graphql`  
  query CalendarIDRQuery {
    allStrapiThisWeeks(filter: {country: {eq: "IDR"}}) {
      edges {
        node {
          id
          date
