...
const CalendarTRYPage = ({ data }) => {
  return (
    ...
    <>
        ...
        <h1><Link to="/calendar">Calendar</Link> / TRY</h1>
...
export default CalendarTRYPage

export const pageQuery = graphql`  
  query CalendarTRYQuery {
    allStrapiThisWeeks(filter: {country: {eq: "TRY"}}) {
      edges {
        node {
          id
          date
