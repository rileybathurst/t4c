...
const CalendarMXNPage = ({ data }) => {
  return (
    ...
    <>
        ...
        <h1><Link to="/calendar">Calendar</Link> / MXN</h1>
...
export default CalendarMXNPage

export const pageQuery = graphql`  
  query CalendarMXNQuery {
    allStrapiThisWeeks(filter: {country: {eq: "MXN"}}) {
      edges {
        node {
          id
          date
