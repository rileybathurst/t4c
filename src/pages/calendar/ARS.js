...
const CalendarARSPage = ({ data }) => {
  return (
    ...
    <>
        ...
        <h1 className="headingStyles">Calendar / ARS</h1>
...
export default CalendarARSPage

export const pageQuery = graphql`  
  query CalendarARSQuery {
    allStrapiThisWeeks(filter: {country: {eq: "ARS"}}) {
      edges {
        node {
          id
          date
