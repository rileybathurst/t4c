...
const CalendarSpainPage = ({ data }) => {
  return (
    ...
    <>
        ...
        <h1><Link to="/calendar">Calendar</Link> / Spain</h1>
...
export default CalendarSpainPage

export const pageQuery = graphql`  
  query CalendarSpainQuery {
    allStrapiThisWeeks(filter: {country: {eq: "Spain"}}) {
      edges {
        node {
          id
          date
